...
class SplayTreeTest {
    ...
    private static SplayNode constructTree() {
        SplayNode root = new SplayNode(HEAD_KEY);
        root.left = new SplayNode(LEFT_KEY);
        root.left.left = new SplayNode(LEFT_LEFT_KEY);
        root.left.right = new SplayNode(LEFT_RIGHT_KEY);
        root.right = new SplayNode(RIGHT_KEY);
        root.right.left = new SplayNode(RIGHT_LEFT_KEY);
        root.right.right = new SplayNode(RIGHT_RIGHT_KEY);
        return root;
    }
